...
This project builds assistive technology for people with disabilities. Many of
our users, testers, and contributors are disabled. Accessibility is not a
feature request here and disability is not a hypothetical — treat both, and the
people who raise them, with the seriousness they deserve.
...
* Ableist language, or dismissing accessibility concerns as edge cases
...
reported to the maintainers at **conduct@continuouspath.org**.
